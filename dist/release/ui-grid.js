...
angular.module('ui.grid').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('ui-grid/ui-grid-recursive-section-header',
    "<div class=\"ui-grid-header-cell ui-grid-clearfix\" ng-style=\"{ 'width': grid.getSectionWidth(section) }\" ng-if=\"grid.isSectionVisible(section)\" style=\"border-right: 0\"><div><div class=\"ui-grid-cell-contents\" style=\"text-align: center\"><span>{{section.displayName}}</span></div></div><div ng-repeat=\"section in section.subSections\"><div ui-grid-recursive-section-header></div></div><div ng-repeat=\"columnName in section.columns\"><div ui-grid-header-cell class=\"ui-grid-header-cell ui-grid-clearfix\" col=\"grid.getColumn(columnName)\" ng-if=\"grid.getColumn(columnName).visible !== false\" render-index=\"grid.columns.indexOf(grid.getColumn(columnName))\"></div></div></div>"
  );
  ...
  $templateCache.put('ui-grid/ui-grid-section-header',
    "<div class=\"ui-grid-header\"><div class=\"ui-grid-top-panel\"><div class=\"ui-grid-header-viewport\"><div class=\"ui-grid-header-canvas\"><div ng-repeat=\"section in grid.options.sectionHeaders\"><div ui-grid-recursive-section-header></div></div></div></div><div ui-grid-menu></div></div></div>"
  );
